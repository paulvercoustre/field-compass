...
// FIX: Corrected import path to point to the types file inside the frontend directory.
import { KoboToolData, KoboQuestion, KoboChoice, KoboVariable } from '../frontend/types';

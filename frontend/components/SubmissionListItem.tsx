...
const SubmissionListItem: React.FC<SubmissionListItemProps> = ({ submission, onSelect, isSelected }) => {
    ...
    const baseClasses = "block w-full text-left p-4 border-b border-gray-800 transition-colors duration-150 focus:outline-none";
    const selectedClasses = "bg-gray-700/50";
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between mb-2">
                <p className="font-mono text-sm font-semibold text-white">ID: {_id}</p>

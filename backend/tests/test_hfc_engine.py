...
class TestDurationChecks:
    ...
    def test_duration_too_short(self, test_db, test_survey_config):
        ...
        issues = engine.run_checks(submission_data=submission_data, submission_uuid="test-uuid")
    ...
    def test_duration_within_range(self, test_db, test_survey_config):
        ...
        duration_issues = [
            i for i in issues if i.check in ["duration_too_short", "duration_too_long"]
        ]

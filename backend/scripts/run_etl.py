...
def main():
    ...
    parser.add_argument('--start-date', help='Only process submissions after this date (YYYY-MM-DD)')
    parser.add_argument('--dry-run', action='store_true', help='Dry run (fetch only, no processing)')

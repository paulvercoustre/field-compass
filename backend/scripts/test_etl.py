...
if __name__ == '__main__':
    ...
    parser.add_argument('--limit', type=int, default=5, help='Limit number of submissions to process')
    parser.add_argument('--create-survey', help='Create a test survey (requires --name, --asset-id, --config)')
